...
class Inflector {
    ...
    public static function underscore($camel_cased_word) {
        return mb_strtolower(preg_replace('/([A-Z]+)([A-Z])/', '\1_\2', preg_replace('/([a-z\d])([A-Z])/', '\1_\2', strval($camel_cased_word))));
    }
    ...
    public static function is_countable($word) {
        return !(\in_array(mb_strtolower(\strval($word)), static::$uncountable_words));
    }
}